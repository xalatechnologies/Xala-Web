...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // WCAG-friendly type scale with larger base sizes
        "display-xl": ["clamp(3rem, 6vw, 5rem)", { lineHeight: "1.1", fontWeight: "700" }],
        "display-lg": ["clamp(2rem, 4.5vw, 3.5rem)", { lineHeight: "1.15" }],
        "display-md": ["clamp(1.25rem, 3vw, 2rem)", { lineHeight: "1.4" }],
        "display-sm": ["clamp(1.125rem, 2vw, 1.5rem)", { lineHeight: "1.4" }],
        ...
        "label-lg": ["0.9375rem", { lineHeight: "1.4", letterSpacing: "0.15em" }],
        "label-md": ["0.875rem", { lineHeight: "1.4", letterSpacing: "0.12em" }],
